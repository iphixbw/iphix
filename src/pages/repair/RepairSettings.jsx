    ...
    <div>
      ...
      <div style={{ background: 'white', borderRadius: '16px', padding: '24px', border: '1px solid #f3ede4', maxWidth: '520px' }}>
        ...
        <p style={{ fontSize: '13px', color: '#57534e', lineHeight: '1.6', margin: '0 0 12px' }}>
          This division operates independently from iPHIX Technologies's retail system — its own customers, inventory, purchases, sales, expenses, and cash account.
        </p>
        <p style={{ fontSize: '13px', color: '#57534e', lineHeight: '1.6', margin: 0 }}>
          The only connection to the main retail accounting is <strong>Bank Deposits</strong> (Cash & Deposits page) — depositing repair cash into one of iPHIX Technologies's existing bank accounts. Everything else stays fully separate.
        </p>
      </div>
    </div>
  )
